...
interface PlayerQrScannerModalContentProps {
...
const PlayerQrScannerModalContent: React.FC<
  PlayerQrScannerModalContentProps
> = ({
  successMessage,
  onScanned,
  onClose,
...
export default PlayerQrScannerModalContent;
