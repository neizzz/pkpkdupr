...
const ForceChangePassword: React.FC = () => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center overflow-hidden pb-[var(--safe-bottom)]">
      <div className="flex max-h-full w-full flex-col justify-center px-4 py-6">
